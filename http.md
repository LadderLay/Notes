...
不是应用层的新协议
http-tcp
http-ssl-tcp 包裹了 SSL 外壳

### 密钥加密
SSL 公开密钥加密
1- 共享密钥/对称密钥加密： 加密和解密同用一个密钥
2- 公开密钥 非对称  private key public key
发送密文的一方使用对方的公开密钥进行加密处理，接收方接收到之后使用自己的私有密钥进行解密
比起共享密钥，处理速度更慢
HTTPS 采用共享密钥加密和公开密钥加密混合加密机制
